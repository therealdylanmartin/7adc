...
?>
  <footer class="footer">
    ...
    <section class="footer__email-capture" id="email-sign-up">
      ...
      <h3 class="subheading-primary email-capture--h3">Be the first to know about special offers and our grand opening.</h3>
      <div class="email-capture--form-container">
        ...
        <form action="https://sevenacredairyco.us14.list-manage.com/subscribe/post?u=4107b8ea5c4588a0f823e7aa2&amp;id=3620838258" method="post" class="email-capture--form" target="_blank" novalidate>
          ...
          <p class="email-capture--p">
            By submitting this form, you are consenting to receive communications from Seven Acre Dairy Company. You can unsubscribe at any time by using the link found at the bottom of every email.
          </p>
